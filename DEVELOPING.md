...
Welcome to the Diamnet Go monorepo. These instructions help launch 🚀 you into making and testing code changes to this repository.
...
```
git clone https://github.com/Diamante-Net/go
```
...
[golistcmp]: https://github.com/diamnet/golistcmp
